...
open class Owner(var id : Int = 0, var login: String? = null) : RealmObject() //this is a constructor
...
data class ErrorResponse(val message: String?) //this is a primary constructor